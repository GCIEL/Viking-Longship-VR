...
public class activateDroplets : MonoBehaviour
{
    ...
    // this function will simply emit water particles when the cup is rotated downward
    void Update()
    {
        ...
        if (shouldEmit && !empty)
        {
            ...
            {
                Vector3 scaleDec = new Vector3(0, 0.01f, 0);
    ...
    // function called by waterSourceEmpty to set empty to false when water fills up
